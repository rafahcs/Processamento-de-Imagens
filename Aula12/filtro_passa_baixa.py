...
# 3. Centralizar as baixas frequências no meio da matriz (Ffftshift)
...
# 5. Definir o raio de corte (r) do filtro passa-baixa
r = 60 

# 6. Criar a máscara H(u,v) baseada nas equações fornecidas
# Inicializa com zero (bloqueia tudo) e define 1 apenas dentro do raio r
...
for u in range(rows):
    for v in range(cols):
        ...
        if dist_quadrado < r**2:
            mask[u, v] = 1  # H(u,v) = 1 se u^2 + v^2 < r^2
...
cv2.imshow('Filtro Passa-Baixa Realizado', img_final)
