# Pegar uma imagem ruído do tipo sal e pimenta(representando descontinuidades abruptas e isoladas na imagem)
#  e aplique o filtro de média e gaussiano

# Implementar a tranasformação de uma imagem com filtro de média com máscara 3x3 e 5x5 utilizando transformação de Fourier

import cv2
import numpy as np

foto = "foto_sal_pimenta.jpg"
